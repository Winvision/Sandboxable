...
namespace Sandboxable.Microsoft.WindowsAzure.Storage.Table
{
    ...
    public class TableEncryptionPolicy
    {
        ...
        internal static async Task<string> RotateEncryptionHelper(KeyRotationEntity rotationEntity, TableRequestOptions modifiedOptions, CancellationToken cancellationToken)
        {
            ...
            IKey oldKey = await modifiedOptions.EncryptionPolicy.KeyResolver.ResolveKeyAsync(tableEncryptionData.WrappedContentKey.KeyId, cancellationToken).ConfigureAwait(false);
