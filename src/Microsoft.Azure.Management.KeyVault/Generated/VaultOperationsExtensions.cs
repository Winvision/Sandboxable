...
namespace Sandboxable.Microsoft.Azure.Management.KeyVault
{
    ...
    /// </summary>
    public static class VaultOperationsExtensions
    {
        /// <summary>
        ...
        {
            return Task.Factory.StartNew(s => ((IVaultOperations)s).CreateOrUpdateAsync(resourceGroupName, vaultName, parameters), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        {
            return Task.Factory.StartNew(s => ((IVaultOperations)s).GetAsync(resourceGroupName, vaultName), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        {
            return Task.Factory.StartNew(s => ((IVaultOperations)s).ListAsync(resourceGroupName, top), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        {
            return Task.Factory.StartNew(s => ((IVaultOperations)s).ListNextAsync(nextLink), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
